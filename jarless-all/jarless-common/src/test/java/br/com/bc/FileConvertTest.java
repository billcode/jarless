...
public class FileConvertTest {
	...
	@Test public void geraServiceDefinition() {
		String content = FileConvertTest.CONSULTAR_CEP_JSON;
		...
		assertEquals("ConsultarCep", pd.getName());
		assertEquals("ConsultarCep.java:" + CONSULTAR_CEP_DATA, pd.getMainClass().toString());
		assertEquals("", pd.getRequest());
		assertEquals("", pd.getResponse());
	}
}
